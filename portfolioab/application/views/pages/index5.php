...
<!DOCTYPE html>
<html lang="en" style="padding-right:0px !important;" >
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><i class="fa fa-wrench"></i>RePairWala.com</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul id="navbar" class="nav navbar-nav navbar-right">
					...
					<li>
                       <a id ="modal-btn" class="page-scroll" data-toggle="modal" data-target="#login-modal" href="#">Login</a>
                    </li>
					<li>
						<a id="userdata" class="page-scroll" href="#"></a>
					</li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
